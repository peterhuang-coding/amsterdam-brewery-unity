...
public class BrewingSystem : MonoBehaviour
{
    ...
    private static readonly BrewRecipe[] Recipes = new BrewRecipe[]
    {
        ...
        new BrewRecipe { id = "whiskey", name = "🥃 Whiskey", emoji = "🥃", ingredientCost = 22, brewTurns = 6, yieldCount = 3, stockIndex = 1 },
        new BrewRecipe { id = "wine", name = "🍷 Wine", emoji = "🍷", ingredientCost = 25, brewTurns = 7, yieldCount = 3, stockIndex = 2 },
    };
