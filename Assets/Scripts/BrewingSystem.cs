...
public class BrewingSystem : MonoBehaviour
{
    ...
    private static readonly BrewRecipe[] Recipes = new BrewRecipe[]
    {
        ...
        new BrewRecipe { id = "ipa", name = "🌿 IPA", emoji = "🌿", ingredientCost = 18, brewTurns = 6, yieldCount = 8, stockIndex = 0 },
        new BrewRecipe { id = "stout", name = "🖤 Stout", emoji = "🖤", ingredientCost = 20, brewTurns = 7, yieldCount = 10, stockIndex = 0 },
    };
